...
int main(int argc, char **argv) {
  ...
  myfile.open("average_delta_g_simulation_" + std::to_string(hinge_num) + "_" +
              "sigma" + sigma + ".csv");
  myfile << "p_pdb_id,Residue length,actual_hinge_cnt,sigma,average_delta_g"
         << std::endl;
